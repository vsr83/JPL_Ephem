...
describe('Figure', function() {
    ...
    it('accOblateness', function() {
        ...
        accOblateness(stateInitial);
        const accSun   = stateInitial.objects[0].accObl;
        const accEarth = stateInitial.objects[3].accObl;
        const accMoon  = stateInitial.objects[4].accObl;
